...
exports.getMyAssets = function(req, res) {
    var querystr = "select assets.name, assets.assetpath, assettype.type from assets, permission, role_perm, user_role, assettype" +
        " where user_role.userpath = ? and assettype.type = ? and  assets.assettype = assettype.id and role_perm.rolepath = user_role.rolepath and permission.permid = role_perm.permid and" +
