...
var getUserAssetPath = function(pgrouppath, assettypeid, assetid) {
...
var createUserQuery = function(queryid, req) {
    return [queryid, 'insert into bczdash.assets(name, assettype) values (?,?)', function(results){
        ...
        if(resultq && "insertId" in resultq){
            ...
            req.body.assetpath = getUserAssetPath(req.body.pgrouppath, req.body.assettypeid, req.body.assetid);
